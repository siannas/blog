...
import HL2CloneGIF from "../images/work_hl2clone.gif"
...
const data = [
    {
        'image' : HL2CloneGIF,
        'title' : '1. Half Life 2 Gravity Gun (Self Learn)',
        'description' : (<>A simple game intended for me to learn Unreal Engine. This simple game was primarily written on C++ code and took me a week to learn from scratch. 
            &nbsp;Here is the <Link to={"https://www.youtube.com/watch?v=zYnvObXkc48"} itemProp="url" target={"_blank"}>[Result]</Link></>)
    },
    {
        'image' : IsolatedForestGIF,
        'title' : '2. Isolated Forest',
    ...
    {
        'image' : HeistersGIF,
        'title' : '4. Heisters: heisters vs heisters',
